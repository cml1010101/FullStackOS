...
class E1000 : public EthernetDevice
{
public:
    bool eepromExists;
    uint16_t ioBase;
    ...
    E1000RXDescriptor* rxDescs;
    E1000TXDescriptor* txDescs;
    uint64_t rxIdx, txIdx;
    void writeCommand(uint16_t addr, uint32_t val);
    uint32_t readCommand(uint16_t addr);
    bool detectEEProm();
